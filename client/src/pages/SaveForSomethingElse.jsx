...
const SaveForSomethingElse = () => {
  ...
  return (
    <div className="min-h-screen mt-8 w-full">
      ...
      <div className="mb-4">
        <label className="block text-sm mb-2 text-amigo-black dark:text-[#ececec] text-[15px] font-light" htmlFor="itemType">
          Do you have something else you want to save for?
        </label>
        <input
          id="itemType"
          type="text"
          ...
          placeholder='Enter the item you want to save for'
        />
      </div>
      <div className="mb-4">
      ...
      {monthlySavings && (
        <div className="mt-4 p-3">
          <p className="text-lg font-medium mb-2 text-amigo-black dark:text-[#ececec]">
            For the {itemType.toLocaleLowerCase()} that costs ₦{price}, you need to save:
          </p>
...
export default SaveForSomethingElse;
